...
<html lang="fr">
<head>
	<title>Témoignages en attente| Crypto Business</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel="stylesheet" href="css_perso/style.css">
	<link rel="stylesheet" href="css_perso/temoignages_en_attente.css">
		...
		if ($getid = $userinfo['id']) 
		{
			if (isset($_SESSION['id']) AND !empty($_SESSION['id'])) 
			{
				...
				if ($getid == $_SESSION['id']) 
				{
					...
					$temoignages = $bdd->prepare('SELECT * from temoignages WHERE statut_temoin = 0');
