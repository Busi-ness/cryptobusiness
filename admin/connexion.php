...
<div class="menu">
 ...
 if (isset($_POST['connexion'])) 
 {
  ...
  if (!empty($_POST['email']) AND !empty($_POST['password']))
  {
    ...
    $usersbdd = $bdd->prepare("SELECT * from users_admins WHERE email= ? and password= ?");
    ...
    if ($userexist == 1) 
    {
      ...
      {
        header('Location: http://crypto.boss-arts.com/admin/accueil.php?id='.$_SESSION['id']);
      ...
      {
        $error = "Vous n'êtes pas encore administrateur";
      }
...
<div class="formgroup">
  ...
  <form action="" method="POST">
   ...
   <div class="bas">
    ...
    <a href="http://crypto.boss-arts.com/admin/inscription.php" class="inscrire">S'inscrire</a> | <a href="http://crypto.boss-arts.com/admin/mot_de_passe_oublie_admin.php" class="mdp">Mot de passe oublié</a>
  </div>
