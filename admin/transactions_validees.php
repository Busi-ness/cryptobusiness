...
<html lang="fr">
<head>
	<title>Transactions validées| Crypto Business</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel="stylesheet" href="css_perso/style.css">
	<link rel="stylesheet" href="css_perso/transactions_validees.css">
		...
		if ($getid = $userinfo['id']) 
		{
			if (isset($_SESSION['id']) AND !empty($_SESSION['id'])) 
			{
				...
				if ($getid == $_SESSION['id']) 
				{
					...
					$transactions = $bdd->prepare('SELECT * from transactions WHERE termine_tr = 1');
					...
					<!-- En tête du tableau -->
					<div>
						<h2>Les transactions validées</h2>
					</div>
					<br/>
