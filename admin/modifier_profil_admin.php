...
<html lang="en">
<head>
  <title>Modifier profil administrateur | Crypto Business</title>
  <link rel="stylesheet" href="css_perso/modifier_profil_admin.css">
      ...
      //Vérifier la longeur du prénom
        ...
        //Vérifier la validité de l'email
            ...
            //Mise à jour des données
                  ...
                  $updateuser = $bdd->prepare("UPDATE users_admins SET name = ?, first_name = ?, email = ? WHERE id = ?");
              ...
              // Variables concernant l'email
                  ...
                  /*$_SESSION['comptecree']*/$note = "Vos informations de profil ont été modifiées avec succès.";
...
<div class="formgroup"> <br>
  <div class="entete">
    <h2>Modification profil administrateur</h2>
    <span>Modifier vos informations de profil</span> <hr>
